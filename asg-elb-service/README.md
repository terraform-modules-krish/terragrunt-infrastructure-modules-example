...
returns "Hello, World". See the [root README](https://github.com/terraform-modules-krish/terragrunt-infrastructure-modules-example/blob/v0.1.0/README.md) for instructions on how to run this example code. 
